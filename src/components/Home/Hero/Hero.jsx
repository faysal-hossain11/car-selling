...
const Hero = () => {
  return (
    <div className=" bg-black text-white">
      <div className=" h-auto md:h-screen container flex flex-col justify-center md:flex-row items-center">
        {/* content section  */}
        <div className=" w-full md:w-2/4 space-y-5 mt-10">
          <h1 className="pt-28 md:mt-0 text-4xl lg:text-6xl font-bold leading-tight">
          ...
          <div className="flex gap-8">
            <button className=" bg-primary border-2 border-primary py-1 px-4 rounded-md hover:bg-transparent hover:border-primary hover:border-2 transition duration-150 ease-linear">
              Explore More
            </button>
